...
# The app itself uses asyncpg at runtime; Alembic uses psycopg2 only here.
...
# Only manage our own tables; exclude PostGIS system tables in tiger/topology/public schemas.
INCLUDE_TABLES = {m.name for m in target_metadata.sorted_tables}
